...
export default function Navbar() {
  ...
  // Using custom getter from Zustand, we need to map the whole state or the specific slice
  ...
  return (
    <nav style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', maxWidth: '1248px', width: '100%', gap: '20px' }}>
        ...
        {/* Logo */}
        <div style={{ cursor: 'pointer', display: 'flex', flexDirection: 'column' }} onClick={() => navigate('/')}>
          <span style={{ color: '#fff', fontSize: '20px', fontStyle: 'italic', fontWeight: 'bold' }}>
            Flipkart
          </span>
        ...
        {/* More */}
        <div style={{ color: '#fff', fontWeight: 500, fontSize: '16px', cursor: 'pointer', display: 'flex', alignItems: 'center' }}>
          More ▾
        </div>

        {/* Cart */}
        <div style={{ color: '#fff', fontWeight: 500, fontSize: '16px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}>
